        ...
        <form action="conf.php" method="post" name=fm onSubmit="is_note_msg=false;">   <!-- フォームデータを result.php へポストメソッドを使用して送信 -->
            ...
            <table>         <!-- テーブル -->
                ...
                <tr>
                    ...
                    <td class = input>
                        <input type='text' maxlength='100' name='surname' size=12 placeholder='例） 問合' required onKeyup=this.value=this.value.replace(/[^ァ-ンぁ-んａ-ｚＡ-Ｚ一-龥]+/i,'');
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class = input>
                        <input type="text" name="name" maxlength="100" size=12 placeholder="例） 太郎" required onKeyup="this.value=this.value.replace(/[^ァ-ンぁ-んａ-ｚＡ-Ｚ一-龥]+/i,'')">    <!-- 名前を入れるテキストボックス -->
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class = input>
                        <input type="text" maxlength="100" name="address" required size=30 placeholder="例） 東京都 問合市 問合1-1" onKeyup="this.value=this.value.replace(/[^ぁ-んａ-ｚＡ-Ｚ一-龥0-9０-９]+/i,'')">     <!-- 住所を入れるテキストボックス -->
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class = input>
                        <input type="text" name="email1" maxlength="100" size=12 onKeyup="this.value=this.value.replace(/[^0-9a-z._-]+/i,'')" placeholder="例） toiawase" required> @  <!--メールアドレスを入れるテキストボックス -->
                        <input type="text" name="email2" maxlength="100" size=12 onKeyup="this.value=this.value.replace(/[^0-9a-z._-]+/i,'')" placeholder=" toiawase.co.jp" required> <!-- 半角英数字以外の文字は全て入力できないように設定 -->
                    </td>
                </tr>
